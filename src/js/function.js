    ...
    function artistAutocomplete(result) {
        ...
        result['items'].map(item => {
            ...
            if (!image.length) {
                ...
                list = `<li class="artistItems action" data-artist_id="${searchArtistId}"><image class="l-searchArtistImage artistImage" src="${imageItems}" loading="lazy"><div class="l-artistInfo"><span class="searchArtistName font-wb">${searchArtistName}</span></div></li>`;
            }
            listItems += list;
        });
